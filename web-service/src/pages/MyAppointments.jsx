                                ...
                                >
                                    <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-6 p-6">
                                        ...
                                        <div className="relative">
                                            <div className="absolute inset-0 bg-linear-to-br from-blue-500 to-cyan-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl"></div>
                                        ...
                                        <div className="flex flex-col justify-between">
                                            <div>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                                    {/* Date & Time */}
                                                    <div className="flex items-start gap-3 p-4 bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl">
                                                    ...
                                                    {/* Location */}
                                                    <div className="flex items-start gap-3 p-4 bg-linear-to-br from-cyan-50 to-blue-50 rounded-xl">
                                                ...
                                                {/* Fee */}
                                                <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-yellow-100 to-orange-100 rounded-xl">
                                                    ...
                                                    <>
                                                        {!appointment.payment ? (
                                                            <button
                                                                ...
                                                                className="flex-1 px-8 py-3 bg-linear-to-r from-green-600 to-emerald-500 text-white rounded-xl font-semibold hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                                                            >
                                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            ...
                                                            <div className="flex-1 px-8 py-3 bg-linear-to-r from-green-100 to-emerald-100 text-green-700 border-2 border-green-500 rounded-xl font-bold flex items-center justify-center gap-2">
