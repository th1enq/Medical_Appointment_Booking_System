                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      required
                      className="w-full h-12 px-4 bg-white border border-gray-300 rounded-md focus:border-teal-500 focus:ring-2 focus:ring-teal-500 focus:outline-none transition-all duration-300"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className="w-full h-12 px-4 bg-white border border-gray-300 rounded-md focus:border-teal-500 focus:ring-2 focus:ring-teal-500 focus:outline-none transition-all duration-300 pr-12"
                      />
                      <button
                        type="button"
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        className="w-4 h-4 rounded border-gray-300 text-teal-500 focus:ring-teal-500 focus:ring-offset-0"
                      />
